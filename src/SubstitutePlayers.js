...
const columnDefs = [
  ...
  { headerName: 'IPLTeam', field: 'iplTeam' ,width:80},
  { headerName: 'Points', field: 'points',width:90,sort: "desc"},
...
//console.log("tea1",specificteamsdata)<Layout></Layout>
  ...
  <Space direction="vertical" style={{width: '100%',height:'100vh'}}size={[0, 48]}>
    ...
    <FormControl sx={{ m: 1, minWidth: 160,borderRadius:'10px', flex:1 }}>
...
<Card size="small" title="Team Data" bordered={true} style={{ width: 300,minHeight: 60,lineHeight: '100%',padding: '0 10px',margintop:'20px',backgroundColor: 'orange'}}>
...
{selectedOption &&
<Content style={{...table, display:"flex",flexDirection:'row',justifyContent:"space-between", overflowX:'auto'}}>

<Content style={{ ...tableContainer,flex:1}}>

<div className="ag-theme-alpine" style={{ height: '500px', width: '500px',overflowX:"hidden"}}>
      <AgGridReact
